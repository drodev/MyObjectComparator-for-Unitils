 ...
 * @author Filip Neven
 */
public class MyReflectionComparatorFactory {
...
//    protected static final Comparator OBJECT_COMPARATOR = new ObjectComparator();
     ...
     * My Comparator
     */
    protected static final Comparator OBJECT_COMPARATOR = new MyObjectComparator();
    ...
    protected static List<Comparator> getComparatorChain(Set<ReflectionComparatorMode> modes) {
        ...
        //comparatorChain.add(ignoredFieldsByClass);
